...
class OrgaController extends \controllers\ControllerBase{
	...
	public function orgaAdd(){
        ...
        $frm->setFields(['name','domain', 'aliases','organisation', 'users','submit']);
        $frm->fieldAsDropDown('organisation',UArrayModels::asKeyValues(DAO::getAll(Organization::class),'getId'));
