	...
	public function newUser(){
		...
		$key='datas/users'.md5($email);
            if(!CacheManager::$cache->exists($key)){
                ...
                $this->showMessage('Création de compte',"Votre compte a été créé avec l'email <b>$email</b>",'SUCESSS');}
            else{
                $this->showMessage('Création de compte',"Vous avez déjà un compte avec l'email <b>$email</b>",'ERROR');
            }
	}
